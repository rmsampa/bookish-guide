...
function bannedKey(evt,en,th,num,space)
{
	...
	if (key!=8 && key!=0) {
		...
		if (num=='yes')	{			
			if (key>=48 && key<=57) { boo1 = true; } else { boo1 = false; }
		} else { boo1 = false; }
		if (en=='yes')	{			
			if ((key>=65 && key<=90) || (key>=97 && key<=122)) { boo2 = true; } else { boo2 = false; }
		} else { boo2 = false; }
		if (th=='yes')	{			
			if ((key>=161 && key<=255) || (key>=3585 && key<=3675)) { boo3 = true; } else { boo3 = false; }
		} else { boo3 = false; }
		if (space!='no')	{			
			if (key==32) { boo4 = true; } else { boo4 = false; }
		} else { boo4 = false; }
...
<table width="1122" height="719" border="0" cellspacing="0" cellpadding="0" class="register">
  <tr>
    ...
    <td><form class="frm" name="frm" action="" method="POST">
        <center><table width="320" border="0" cellpadding="0" cellspacing="0">
<tr><!-- -->
...
Masculino
  ...
  <tr>
    ...
    <td align="left"><input name="char" type="text" class="textfield" size="24" maxlength="15"  onKeypress="bannedKey(event,'yes','yes','yes','no')"/></td>
          ...
          <span class="style1"><center></center>
          </span><br /><!-- -->
